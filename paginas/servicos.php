  ...
  <div class="container">
    <header class="mb-5 text-center">
      <h2 class="display-4 fw-bold">
        Nossos <span class="">Serviços</span>
      </h2>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card bg-dark border-warning shadow-lg h-100">
          <div class="card-body d-flex flex-column">
            ...
            <h5 class="card-title text-warning">Corte Masculino</h5>
            <p class="card-text text-muted">
              Técnicas modernas e clássicas para cortes personalizados que combinam com seu estilo e personalidade.
            </p>
            <a href="agendar" class="btn btn-warning mt-auto align-self-center px-4 fw-semibold">
              Agendar Corte
            </a>
          </div>
        </div>
    ...
    <div class="text-center">
      ...
      <a href="agendar" class="btn btn-lg btn-warning px-5 fw-semibold shadow-lg mt-3">
